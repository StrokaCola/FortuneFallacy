...
// Babel-standalone evaluates `<script type="text/babel">` files as their
// fetches resolve — not strictly in DOM order. With our module script tag
// in the mix, app.jsx can finish before cosmos.jsx, leaving `Die` and
// friends undefined. Defer mount until window load + a microtask so every
// sibling babel script has had a chance to publish its globals.
function mount() {
