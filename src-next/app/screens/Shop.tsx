...
export function Shop() {
  ...
  return (
    <div style={{ position: 'absolute', inset: 0, pointerEvents: 'auto' }}>
      ...
      <div style={{ position: 'absolute', left: '50%', top: 180, transform: 'translateX(-50%)', textAlign: 'center', zIndex: 4 }}>
      ...
      <div style={{
        ...
        {offers.length === 0 && <div className="f-mono" style={{ color: '#bba8ff' }}>— sold out —</div>}
        {offers.map((o, i) => {
          ...
          return (
            <button
              ...
              <div style={{ fontSize: 11, color: '#bba8ff', marginTop: 6, textAlign: 'center', lineHeight: 1.4, flex: 1 }}>
                {m.desc}
              </div>
              <div style={{
                ...
                <span className="f-mono uc" style={{
                  ...
                  color: affordable ? accent : '#e2334a',
                }}>
                  {affordable ? 'buy' : 'low'}
                </span>
              </div>
